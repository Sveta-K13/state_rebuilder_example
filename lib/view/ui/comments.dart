...
import 'package:demo_state_rebuilder/services/comments_service.dart';
...
class Comments extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Injector(
      ...
      builder: (context) {
        return StateBuilder(
          observe: () => Injector.getAsReactive<CommentsService>(),
              ...
              onData: (state) => Expanded(
                child: ListView(
                  children: state.comments
                      .map<Widget>((comment) => CommentItem(comment))
                      .toList(),
                ),
              ),
